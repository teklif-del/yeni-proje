...
const BASLANGIC_OGRENCILER = [
  ...OGRENCILER.map(o => {
    // id:4 Fatma Çelik → SRC demo verisi
    if (o.id === 4) {
      return { ...o, src: {
        sinavlar: [
          { id: 1, tarih: '2025-02-15', puan: '45', rapor: false, not: '' },
          { id: 2, tarih: '2025-03-01', puan: '52', rapor: false, not: 'Teori kısmında eksik' },
          { id: 3, tarih: '2025-03-20', puan: '38', rapor: true,  not: 'Raporlu devamsızlık — ek hak verildi' },
        ],
        belgeTarihi: '', belgeNo: '',
      }};
    }
  ...
  // SRC demo öğrencileri
  {
    id: 201, subeId: 10, ad: 'Hüseyin', soyad: 'Kılıç', tc: '33333333301',
    telefon: '0532 901 23 45', email: '',
    kayitTarihi: '2025-01-10', kurstipi: 'SRC 2',
    durum: 'tamamladi', toplamUcret: 4500, odenenUcret: 4500,
    src: {
      sinavlar: [
        { id: 1, tarih: '2025-02-01', puan: '55', rapor: false, not: '' },
        { id: 2, tarih: '2025-02-22', puan: '72', rapor: false, not: '' },
      ],
      belgeTarihi: '2025-03-01', belgeNo: 'SRC-2025-0042',
    }
  },
  {
    id: 202, subeId: 10, ad: 'Özlem', soyad: 'Güler', tc: '33333333302',
    telefon: '0544 567 89 01', email: '',
    kayitTarihi: '2025-01-20', kurstipi: 'SRC 4',
    durum: 'devam_ediyor', toplamUcret: 4800, odenenUcret: 2400,
    src: {
      sinavlar: [
        { id: 1, tarih: '2025-02-10', puan: '40', rapor: false, not: '' },
        { id: 2, tarih: '2025-02-28', puan: '58', rapor: false, not: '' },
        { id: 3, tarih: '2025-03-10', puan: '48', rapor: false, not: '' },
        { id: 4, tarih: '2025-03-20', puan: '51', rapor: true,  not: 'Sağlık raporu mevcut — ek hak' },
      ],
      belgeTarihi: '', belgeNo: '',
    }
  },
  {
    id: 203, subeId: 11, ad: 'Cemil', soyad: 'Arslan', tc: '33333333303',
    telefon: '0555 234 56 78', email: '',
    kayitTarihi: '2025-02-01', kurstipi: 'SRC 2',
    durum: 'devam_ediyor', toplamUcret: 4500, odenenUcret: 4500,
    src: {
      sinavlar: [
        { id: 1, tarih: '2025-02-20', puan: '30', rapor: false, not: '' },
        { id: 2, tarih: '2025-03-05', puan: '42', rapor: false, not: '' },
        { id: 3, tarih: '2025-03-15', puan: '35', rapor: false, not: '' },
        { id: 4, tarih: '2025-03-22', puan: '28', rapor: false, not: '' },
        { id: 5, tarih: '2025-03-28', puan: '33', rapor: false, not: '' },
        { id: 6, tarih: '2025-04-05', puan: '41', rapor: false, not: '' },
        { id: 7, tarih: '2025-04-10', puan: '38', rapor: false, not: '' },
        { id: 8, tarih: '2025-04-18', puan: '55', rapor: false, not: 'Son sınav — hak bitti' },
      ],
      belgeTarihi: '', belgeNo: '',
    }
  },

  // SRC 5 demo öğrencisi (4 hak / 70 puan)
  {
    id: 204, subeId: 15, ad: 'Mustafa', soyad: 'Demir', tc: '33333333304',
    telefon: '0533 410 22 33', email: '',
    kayitTarihi: '2025-02-15', kurstipi: 'SRC 5',
    durum: 'tamamladi', toplamUcret: 5000, odenenUcret: 5000,
    src: {
      sinavlar: [
        { id: 1, tarih: '2025-03-05', puan: '58', rapor: false, not: '' },
        { id: 2, tarih: '2025-03-20', puan: '74', rapor: false, not: 'Geçti!' },
      ],
      belgeTarihi: '2025-03-22', belgeNo: 'SRC5-2025-0018',
    }
  },
  {
    id: 205, subeId: 15, ad: 'Ayeşe', soyad: 'Yıldız', tc: '33333333305',
    telefon: '0544 520 44 55', email: '',
    kayitTarihi: '2025-03-01', kurstipi: 'SRC 5',
    durum: 'devam_ediyor', toplamUcret: 5000, odenenUcret: 2500,
    src: {
      sinavlar: [
        { id: 1, tarih: '2025-03-15', puan: '55', rapor: false, not: '' },
        { id: 2, tarih: '2025-03-28', puan: '62', rapor: false, not: '' },
        { id: 3, tarih: '2025-04-10', puan: '45', rapor: true,  not: 'Sağlık raporu — ek hak verildi' },
      ],
      belgeTarihi: '', belgeNo: '',
    }
  },

  // TMGD demo öğrencileri (4 hak / 70 puan)
  {
    id: 301, subeId: 16, ad: 'Serkan', soyad: 'Koç', tc: '44444444401',
    telefon: '0532 301 55 66', email: 'serkan@mail.com',
    kayitTarihi: '2025-01-15', kurstipi: 'TMGD Temel',
    durum: 'tamamladi', toplamUcret: 6000, odenenUcret: 6000,
    src: {
      sinavlar: [
        { id: 1, tarih: '2025-02-10', puan: '65', rapor: false, not: '' },
        { id: 2, tarih: '2025-02-25', puan: '78', rapor: false, not: 'Geçti!' },
      ],
      belgeTarihi: '2025-03-01', belgeNo: 'TMGD-2025-0007',
    }
  },
  {
    id: 302, subeId: 16, ad: 'Fatih', soyad: 'Ateş', tc: '44444444402',
    telefon: '0555 302 77 88', email: '',
    kayitTarihi: '2025-02-01', kurstipi: 'TMGD Yenileme',
    durum: 'devam_ediyor', toplamUcret: 4000, odenenUcret: 4000,
    src: {
      sinavlar: [
        { id: 1, tarih: '2025-03-01', puan: '50', rapor: false, not: '' },
        { id: 2, tarih: '2025-03-15', puan: '60', rapor: false, not: '' },
        { id: 3, tarih: '2025-03-28', puan: '55', rapor: false, not: '' },
        { id: 4, tarih: '2025-04-10', puan: '67', rapor: false, not: 'Son hak kullanıldı, dosya yandı' },
      ],
      belgeTarihi: '', belgeNo: '',
    }
  },
  {
    id: 303, subeId: 16, ad: 'Merve', soyad: 'Bulut', tc: '44444444403',
    telefon: '0544 303 99 10', email: '',
    kayitTarihi: '2025-02-10', kurstipi: 'TMGD Temel',
    durum: 'devam_ediyor', toplamUcret: 6000, odenenUcret: 3000,
    src: {
      sinavlar: [
        { id: 1, tarih: '2025-03-10', puan: '62', rapor: false, not: '' },
        { id: 2, tarih: '2025-03-25', puan: '58', rapor: true,  not: 'Raporlu ek hak' },
      ],
      belgeTarihi: '', belgeNo: '',
    }
  },
  ...
  },
  {
    ...
    psiko: {
      ...
      randevuDurumu: 'gerceklesti',
      testSonucu: 'basarisiz', testTarihi: '2025-03-15', testNotu: 'Reaksiyon testi başarısız.',
